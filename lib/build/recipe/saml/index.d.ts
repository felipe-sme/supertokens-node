...
export default class Wrapper {
    ...
    >;
    static listClients(input: { tenantId: string; userContext?: Record<string, any> }): Promise<{
        status: "OK";
        clients: import("./types").SAMLClient[];
    }>;
    static removeClient(input: { tenantId: string; clientId: string; userContext?: Record<string, any> }): Promise<{
        status: "OK";
        didExist: boolean;
    }>;
